...
@section('title', 'Edit Your Profile - MVMS')

@section('page-title', 'Edit Your Volunteer Profile')
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card border-0 bg-gradient" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                <div class="card-body text-white p-4">
                    <h2 class="mb-2">
                        <i class="bi bi-person-gear me-2"></i>Edit Your Volunteer Profile
                    </h2>
                    <p class="mb-0">
                        Update your profile information to keep it current and improve volunteer matching.
                    </p>
    ...
    <!-- Profile Form -->
    <form id="volunteerProfileForm" action="{{ route('volunteer.profile.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="full_name" name="full_name"
                               value="{{ $profile->full_name ?? Auth::user()->name }}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="can_travel" name="can_travel">
...
$(document).ready(function() {
    ...
    $('#volunteerProfileForm').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("volunteer.profile.update") }}',
            method: 'PUT',
            data: formData,
            processData: false,
            contentType: false,

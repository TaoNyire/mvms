...
<head>
    ...
    <style>
        ...
        /* Volunteer-specific colors and components */
        .btn {
            font-weight: 600;
            border-radius: 12px;
            padding: 12px 24px;
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item mt-3">
                <div class="nav-section-header px-3 py-2">
                    <small class="text-light opacity-75 fw-semibold">TASKS</small>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('volunteer.tasks.index') }}">
                    <i class="bi bi-list-task"></i>
                    <span>My Tasks</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('volunteer.tasks.browse') }}">
                    <i class="bi bi-search"></i>
        ...
        <header class="top-header">
            ...
            <div class="user-menu dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('volunteer.profile.show') }}"><i class="bi bi-person me-2"></i>Profile</a></li>
